...
const Contact = () => {
  ...
  return (
    <div className="max-w-5xl bg-black mx-auto px-8 py-12 text-white" id = "contact">
      ...
      <div className="flex gap-4 justify-center items-center sm:flex-row sm:justify-center">
      ...
      <div className="text-center sm:text-center mt-8">
        <div className="bg-black rounded-lg shadow-lg p-4 flex flex-col sm:flex-row justify-center items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <p className='font-medium font-sans text-lg'>ayush02jaiswal@gmail.com</p>
          </div>
          <div className="flex items-center gap-2">
            <p className="text-lg font-semibold">📞</p>
            <p className='font-medium font-sans text-lg' >+917052355283</p>
          </div>
        </div>
      </div>
    </div>
